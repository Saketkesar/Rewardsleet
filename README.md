...
1. **Download the Extension:**
   - Click [here](https://github.com/Saketkesar/Rewardsleet/releases/download/v1.1.2/Rewardsleet1.1.2.zip) to download the latest version of the extension (ZIP file).
